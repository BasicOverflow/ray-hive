"""Deploy a VL model with video limits and run chat on a short mp4 fixture."""
import os
import sys
...
VIDEO = Path(__file__).resolve().parent / "media" / "video_00.mp4"
MODEL_ID = "video-demo"
MODEL_NAME = "Qwen/Qwen2.5-VL-3B-Instruct"
MAX_IN, MAX_OUT = 4096, 256


VLLM_KWARGS = dict(
    trust_remote_code=True,
    limit_mm_per_prompt={"video": 1, "image": 0},
    mm_processor_kwargs={"max_pixels": 768 * 768, "nframes": 8},
    max_num_seqs=2,
)
