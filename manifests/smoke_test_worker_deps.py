...
assert fastapi.__version__ == "0.133.0", f"fastapi {fastapi.__version__} (want 0.133.0)"
assert hasattr(fastapi_routing, "_DefaultLifespan"), "fastapi.routing missing _DefaultLifespan"
