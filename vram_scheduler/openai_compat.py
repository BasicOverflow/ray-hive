"""OpenAI API compatibility layer for VRAM scheduler.
...
- Support chat completions API format
- Support streaming responses in OpenAI format
...
#     # Convert OpenAI format to VRAM scheduler format
